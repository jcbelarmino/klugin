    ...
    UIViewController *modalViewController = [topViewController presentedViewController ];
     ...
     if (![modalViewController isKindOfClass:[KILoginViewController class]]) {
         UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"MainStoryboard"
                                                       bundle:nil];
         KILoginViewController* loginViewController = [sb instantiateViewControllerWithIdentifier:@"KILoginViewController"];
         [topViewController presentViewController:loginViewController animated:NO completion:nil];
     }else{
         KILoginViewController* loginViewController =
         (KILoginViewController*)modalViewController;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"klug_in" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"klug_in.sqlite"];
